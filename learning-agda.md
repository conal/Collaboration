...
*   Part one (Logical Foundations) of [Programming Language Foundations in Agda](https://plfa.github.io/).
    Parts two and three are about operational semantics of programming languages, leading to complex theorems and proofs rather than simply correct computation.
